...
=======
# Generated by Django 4.1.13 on 2024-12-13 12:10
>>>>>>> dev-branch
...
=======
                ...
                ('handle', models.SlugField(unique=True)),
                ('price', models.DecimalField(decimal_places=3, default=999, max_digits=10)),
                ('og_price', models.DecimalField(decimal_places=3, default=999, max_digits=10)),
                ('stripe_price', models.IntegerField(default=999)),
                ('price_changed_timestamp', models.DateTimeField(blank=True, null=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
